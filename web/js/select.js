(function($, window, document, undefined) {
    ...
    $.fn.mySelect.template = '' + '<div class="select-picker-search">' + '<div class="select-picker-search-checked"></div>' + '</div>' + '<div class="select-picker-options-wrp">' + '<div class="select-picker-options-serch">' + '<input type="text" placeholder="">' + '</div>' + '<div class="select-picker-options-list"></div>' + '<div class="select-picker-options-list-alert hidden">No Content</div>' + '<div class="select-picker-btn-group">' + '<div class="select-picker-btn-cancel">取消</div>' + '</div>' + '</div>';
